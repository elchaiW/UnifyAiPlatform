  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 safe-area-pt">
        ...
        {/* Mobile content spacer to account for fixed header */}
